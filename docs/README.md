...
Las [auditorías](audits) registran revisiones fechadas, fuentes, límites y
comprobaciones pendientes. El [CHANGELOG](../CHANGELOG.md) conserva el historial
de publicación. Sus menciones a `configuration/backend_configuration/` describen
la estructura anterior; la ruta actual de las fuentes es `configuration/`.
